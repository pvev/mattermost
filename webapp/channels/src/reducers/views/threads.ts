...
const selectedThreadIdInTeam = (state: ViewsState['threads']['selectedThreadIdInTeam'] = {}, action: AnyAction) => {
    switch (action.type) {
...
const lastViewedAt = (state: ViewsState['threads']['lastViewedAt'] = {}, action: AnyAction) => {
    switch (action.type) {
...
function manuallyUnread(state: ViewsState['threads']['manuallyUnread'] = {}, action: AnyAction) {
    switch (action.type) {
    case Threads.CHANGED_LAST_VIEWED_AT:
        return {
            ...state,
...
function toastStatus(state: ViewsState['threads']['toastStatus'] = false, action: AnyAction) {
    switch (action.type) {
