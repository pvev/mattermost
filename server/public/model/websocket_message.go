...
const (
	...
	WebsocketEventAccessControlTemporaryAccessPrompt  WebsocketEventType = "access_control_temporary_access_prompt"
	WebsocketEventAccessControlTemporaryAccessExpired WebsocketEventType = "access_control_temporary_access_expired"
