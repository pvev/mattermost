...
describe('Image URL Preview', () => {
    ...
    it('MM-T2 - Image URL without file extension in markdown format opens correctly in preview modal', () => {
        ...
        const imageUrl = 'https://i.stack.imgur.com/MNeE7.jpg';
        ...
        // * Verify the preview modal opens and the image is displayed correctly
        cy.findByTestId('imagePreview').should('be.visible').and('have.class', 'image_preview__image').and('have.attr', 'alt', 'preview url image').and('have.attr', 'src').and('include', 'imgur');
