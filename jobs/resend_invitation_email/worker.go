...
func (rseworker *ResendInvitationEmailWorker) cleanChannelsData(channelStringData string) ([]string, error) {
	// emailStringData looks like this ["uuuiiiiidddd","uuuiiiiidddd"]
	channels := []string{}
...
func (rseworker *ResendInvitationEmailWorker) ResendEmails(job *model.Job, interval string) {
	...
	//here validate how does the channelList data looks like when it comes and then add a validation to it
	...
	// same here, make sure the channelList has a len
