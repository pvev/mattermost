...
func TestValidateConditionValues_PublicFieldAllowsAnyValues(t *testing.T) {
	...
	// We test this by verifying getFieldAccessMode returns public for the field
	...
	assert.Equal(t, model.PropertyAccessModePublic, getFieldAccessMode(field))
}
...
func TestValidateConditionValues_SourceOnlyRejectsLiterals(t *testing.T) {
	...
	assert.Equal(t, model.PropertyAccessModeSourceOnly, getFieldAccessMode(field))
}
