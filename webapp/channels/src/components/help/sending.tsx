                ...
                <section className='Help__section'>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage={"Delete a message by selecting the <b>More Actions [...]</b> icon next to any message text that you've composed, then select <b>Delete</b>. System and Team Admins can delete any message on their system or team."}
                            values={{
                                b: (chunks: React.ReactNode) => <b>{chunks}</b>,
                            }}
                        />
