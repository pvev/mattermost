...
func (a *OpenTracingAppLayer) ExecuteWorkTemplate(c *request.Context, wtcr *worktemplates.ExecutionRequest, installPlugins bool) (*model.WorkTemplateChannelsExecutionResult, *model.AppError) {
	origCtx := a.ctx
