...
func GenerateClientConfig(c *model.Config, telemetryID string, license *model.License) map[string]string {
	...
	props["EnableDelegatedCELEditor"] = strconv.FormatBool(*c.AccessControlSettings.EnableDelegatedCELEditor)
	props["AllowedOperatorsForDelegatedAdmins"] = strings.Join(c.AccessControlSettings.AllowedOperatorsForDelegatedAdmins, ",")
